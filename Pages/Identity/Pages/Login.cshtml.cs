...
namespace Eduhunt.Pages.Identity.Pages
{
    public class LoginModel : PageModel
    {
        ...
        [BindProperty]
        public string Email { get; set; }  // Changed to Email to reflect the login method
        ...
        {
            var user = new CognitoUser(Email, _configuration["AWS:ClientId"], _userPool, _provider); // Use Email instead of Username
